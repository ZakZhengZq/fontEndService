<template>
    <div>
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80" v-if="isChanging">
            ...
            <markdown-editor v-model="formValidate.article" ref="markdownEditor"></markdown-editor>
            </FormItem>
            <FormItem>
...
/* eslint-disable */
    export default {
        ...
        created() {
            axios.get('http://localhost:3000/manager/getAllArts')
            .then((response) => {
        ...
        methods: {
            ...
            handleSubmit (name) {
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        axios.post('http://localhost:3000/blog/upSertArt', {
